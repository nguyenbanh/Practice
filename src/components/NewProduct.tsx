...
declare namespace Demo {
    ...
    type Product = {
        ...
        rating?: number;
        orders?: ProductOrder[];
        [key: string]: string | string[] | number | boolean | undefined | ProductOrder[] | any | File[];
    };
...
function NewProduct() {
    ...
    const itemTemplate = (file: object, props: ItemTemplateOptions) => {
        ...
        return (
            <div className="flex h-8rem overflow-y-auto py-3 border-round" style={{ cursor: 'copy' }} onClick={onFileUploadClick}>
