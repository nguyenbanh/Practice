            ...
            <div className="col-12">
              {order.products.map((product, i) => {
                return (
                  <div
                    key={i}
                    className="p-2 my-4 flex  lg:flex-row justify-content-between align-items-center"
                  >
                    <div className="flex lg:flex-row justify-content-center align-items-center px-2">
                      <img
                        src={product.image}
                        alt="product"
                        className="w-8rem h-8rem mr-3 flex-shrink-0"
                      />
                      <div className="flex flex-column my-auto md:text-left">
                        ...
                        <a
                          tabIndex={0}
                          className="p-ripple p-2 select-none cursor-pointer w-10rem lg:mx-0 border-round font-medium border-1 border-primary text-primary transition-duration-150"
                        >
                          Buy Again{" "}
